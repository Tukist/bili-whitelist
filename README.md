...
- **搜索 / UP 主管理**：搜索页支持「全部 B 站 / 我的白名单 / 搜索 UP 主」三类入口；结果可**一键加入白名单**但不会自动入库。首页 PageView 三页（历史记录 / 合集主页 / UP 主管理），**左滑**到「白名单 UP 主」页后可查看、进入、移除已加入 UP 主；UP 主详情页支持在该 UP 主投稿内搜索视频，**v2.17.4+ 另有「合集」区**（见上：展示该 UP 主合集/列表，点合集查看其视频，可播放/加入白名单）
